...
public class BearingAngles extends Controller {
    ...
    public BearingAngles(SphericalTriangle sphericalTriangle, Point aPoint, Point bPoint, Controller.CASE caseType) {
    ...
    private void verifySpecialCasesBearingAngles() {
        ...
        } else if (getCaseType() == Controller.CASE.OPPOSITE_POINTS) {
